...
import mint_img3_url from '../../assets/img/mint_img3.svg';

export default function RedeemGdcForm() {
    const [openDropDown, setOpenDropDown] = useState(false);
    const [selectedCoin, setSelectedCoin] = useState("GDC");
    const [selectedCoinImg, setSelectedCoinImg] = useState(mint_img3_url);

...
import vault_img10_url from "../../assets/img/vault_img10.svg";

export default function ToVault() {
    const [openDropDown, setOpenDropDown] = useState(false);
    const [selectedCoin, setSelectedCoin] = useState("GDC");
    const [selectedCoinImg, setSelectedCoinImg] = useState(vault_img10_url);
    ...
    return (
        <div className="radius-8 bg-trans p-3 position-relative">
            <div className='d-flex v-center space-between'>
                <div>
                    <div className='font-20 bold-700 color-white'>50,000.00</div>
                    <div className='font-14 bold-300 color-gray mt-2'>$50,000.00</div>
                </div>
                <div className='text-end'>
                    ...
                    <div className='font-14 bold-300 color-gray mt-2'>Balance: 0</div>
                </div>
            </div>
            <div>

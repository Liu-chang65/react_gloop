...
export default function FromVault() {
    const [openDropDown, setOpenDropDown] = useState(false);
    const [selectedCoin, setSelectedCoin] = useState("IOU");
    const [selectedCoinImg, setSelectedCoinImg] = useState(vault_img9_url);
        ...
        <div className="radius-8 bg-trans p-3 position-relative">
            <div className='d-flex v-center space-between'>
                ...
                <div className='text-end'>
                    ...
                    <div className='font-14 bold-300 color-gray mt-2'>Balance: 50,000.00</div>
                </div>
            </div>
            <div>
